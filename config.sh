...
EXTERNAL_ACCOUNT_PROVIDER=${EXTERNAL_ACCOUNT_PROVIDER:-""}
EXTERNAL_ACCOUNT_EXTERNAL_ID=${EXTERNAL_ACCOUNT_EXTERNAL_ID:-""}
EXTERNAL_ACCOUNT_APPLICATION_ID=${EXTERNAL_ACCOUNT_APPLICATION_ID:-""}
